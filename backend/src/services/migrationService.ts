...
Available Verxio node types: MANUAL_TRIGGER, HTTP_REQUEST, WEBHOOK, ANTHROPIC, GEMINI, OPENAI, DISCORD, SLACK, WHATSAPP, TELEGRAM, DECIDER, GOOGLE_DRIVE, GOOGLE_CALENDAR, GOOGLE_SHEETS, GOOGLE_DOCS, GOOGLE_MEET, GOOGLE_SLIDES, GMAIL, AIRTABLE, CODE_BLOCK, COMPOSIO_ACTION, STRAPI, DESIGN, VEO, AGENT_TEAM
