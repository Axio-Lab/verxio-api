...
Required for all workflow endpoints. This header should contain the authenticated user's email address from Better Auth session.`,
  ...
  tags: [
    ...
    // },
    {
      ...
      description:
        "create, update, and manage loyalty programs, issue loyalty passes, and award/revoke points",
    },
    {
      name: "Loyalty Cards and Vouchers",
      description:
        "create, mint, validate, redeem, cancel, and extend expiry of loyalty card and vouchers",
    },
    {
      name: "Deals",
