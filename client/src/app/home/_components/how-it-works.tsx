...
const TABS: TabContent[] = [
  ...
  },
  {
    ...
    label: "Task Manager",
    icon: ClipboardCheck,
    headline: "Assign tasks. AI supervises compliance.",
    description:
      "Create recurring human tasks with rules and evidence requirements. Workers submit proof via messaging apps, and AI scores every submission.",
    steps: [
      { text: "Create a task with rules and schedule", icon: ClipboardCheck },
      { text: "Add workers via WhatsApp, Telegram, or Slack", icon: Users },
      { text: "Workers submit photo or document evidence", icon: Camera },
      { text: "AI vets against reference, scores, and reports", icon: BarChart3 },
    ],
    visual: {
      type: "timeline",
      items: [
        { label: "8:00 AM", sublabel: "Reminder sent to team", status: "done" },
        { label: "8:15 AM", sublabel: "Photo evidence submitted", status: "done" },
        { label: "8:16 AM", sublabel: "AI scored: 94/100", status: "done" },
        { label: "5:00 PM", sublabel: "Daily report generated", status: "active" },
      ],
    },
  },
  {
