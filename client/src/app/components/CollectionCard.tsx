  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-card">
      ...
      <div className="flex flex-wrap gap-2 text-sm text-textSecondary">
        {country && <span className="rounded-full bg-gray-50 px-3 py-1">Country: {country}</span>}
        <span className="rounded-full bg-gray-50 px-3 py-1">Expires: {expiry}</span>
        {tradeable ? (
