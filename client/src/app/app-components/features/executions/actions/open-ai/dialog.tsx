...
export const OpenAIDialog = ({ open, onOpenChange, onSubmit, defaultValues = {} }: Props) => {
  ...
  const { data: credentialsData } = useCredentials(1, 100, CredentialType.OPENAI);
  const openAICredentials = credentialsData?.credentials || [];
                      ...
                      <SelectContent>
                        {openAICredentials.length === 0 ? (
                          <div className="px-2 py-1.5 text-sm text-muted-foreground">
                            No OpenAI credentials found. Create one in Credentials.
                          </div>
                        ) : (
                          <>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>The OpenAI model to use for text generation.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
