              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      The Airtable Base ID. You can find this in your base URL or by listing bases.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      The Airtable Table ID or name. You can find this by listing tables in a base.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Optional: A formula used to filter records. See Airtable formula reference.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      ...
                      Doe", "Email": "john@example.com"{"}"}. You can use Handlebars templates like{" "}
                      {"{"}
