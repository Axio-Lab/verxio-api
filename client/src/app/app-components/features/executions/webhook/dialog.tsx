    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md w-[calc(100%-2rem)] sm:w-full sm:max-w-md max-h-[90vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <DialogDescription>
            Configure your webhook endpoint. External services can POST to this URL to trigger your
            workflow.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <div className="space-y-6 mt-4 overflow-y-auto flex-1 pr-2 -mr-2">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Copy this URL and use it as your webhook endpoint. POST requests to this URL will
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="webhook" />
                    </FormControl>
                    <FormDescription>
                      Use this name to reference the webhook data in other nodes:{" "}
                      {`{{${watchVariables}.payload}}`} or {`{{${watchVariables}.headers}}`}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Optional secret for webhook authentication. If set, include it in the{" "}
                      <code className="text-xs">X-Webhook-Secret</code> header or as a Bearer token.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
