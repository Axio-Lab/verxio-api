    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md w-[calc(100%-2rem)] sm:w-full sm:max-w-md max-h-[90vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <DialogDescription>
            Configure this webhook URL in your Stripe Dashboard to trigger this workflow on stripe
            events.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          ...
          >
            ...
            <div className="rounded-lg bg-muted p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>
                  <code className="bg-background px-1 py-0.5 rounded">{"{{stripe.data}}"}</code>-
                  Event data object
                </li>
                <li>
                  <code className="bg-background px-1 py-0.5 rounded">
