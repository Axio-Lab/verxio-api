...
import { CredentialsLoadingView, CredentialsErrorView } from "@/app/app-components/features/credentials/credential";
...
const CredentialsPage = () => {
  return (
    <ErrorBoundary
      FallbackComponent={CredentialsErrorBoundaryFallback}
    >
